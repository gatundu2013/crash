...
>(({ className, type, ...props }, ref) => {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "file:text-foreground placeholder:text-white/70 selection:bg-primary selection:text-primary-foreground bg-layer-2 dark:bg-input/30 flex h-10 w-full min-w-0 rounded-md border border-white/15 px-3 py-1 text-base shadow-xs transition-all duration-200 ease-out outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
